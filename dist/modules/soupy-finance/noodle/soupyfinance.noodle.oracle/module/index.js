...
const tx_1 = require("./types/oracle/tx");
const types = [
    ["/soupyfinance.noodle.oracle.MsgUpdatePrices", tx_1.MsgUpdatePrices],
];
...
const txClient = (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        ...
        msgUpdatePrices: (data) => ({ typeUrl: "/soupyfinance.noodle.oracle.MsgUpdatePrices", value: tx_1.MsgUpdatePrices.fromPartial(data) }),
    };
});
