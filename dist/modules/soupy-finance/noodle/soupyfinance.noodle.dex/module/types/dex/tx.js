...
exports.MsgClientImpl = exports.MsgCancelOrderResponse = exports.MsgCancelOrder = exports.MsgCreateOrderResponse = exports.MsgCreateOrder = exports.protobufPackage = void 0;
/* eslint-disable */
...
class MsgClientImpl {
    ...
    CancelOrder(request) {
        ...
        const promise = this.rpc.request("soupyfinance.noodle.dex.Msg", "CancelOrder", data);
        return promise.then((data) => exports.MsgCancelOrderResponse.decode(new minimal_1.Reader(data)));
    }
}
