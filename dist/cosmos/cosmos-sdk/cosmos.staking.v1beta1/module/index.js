...
const types = [
    ...
    ["/cosmos.staking.v1beta1.MsgUndelegate", tx_2.MsgUndelegate],
...
const txClient = (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        ...
        msgUndelegate: (data) => ({ typeUrl: "/cosmos.staking.v1beta1.MsgUndelegate", value: tx_2.MsgUndelegate.fromPartial(data) }),
        msgCreateValidator: (data) => ({ typeUrl: "/cosmos.staking.v1beta1.MsgCreateValidator", value: tx_3.MsgCreateValidator.fromPartial(data) }),
        msgDelegate: (data) => ({ typeUrl: "/cosmos.staking.v1beta1.MsgDelegate", value: tx_4.MsgDelegate.fromPartial(data) }),
        msgEditValidator: (data) => ({ typeUrl: "/cosmos.staking.v1beta1.MsgEditValidator", value: tx_5.MsgEditValidator.fromPartial(data) }),
    };
});
