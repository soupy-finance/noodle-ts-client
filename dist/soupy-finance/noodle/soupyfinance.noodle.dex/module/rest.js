...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryBook = (market, side, params = {}) => this.request(Object.assign({ path: `/soupy-finance/noodle/dex/book/${market}/${side}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryBooks = (market, params = {}) => this.request(Object.assign({ path: `/soupy-finance/noodle/dex/books/${market}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/soupy-finance/noodle/dex/params`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
