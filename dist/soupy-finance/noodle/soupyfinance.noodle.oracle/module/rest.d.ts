export declare type OracleMsgUpdatePricesResponse = object;
/**
...
export interface OracleQueryPricesResponse {
    data?: string;
}
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryPrices: (assets: string[], params?: RequestParams) => Promise<HttpResponse<OracleQueryPricesResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
