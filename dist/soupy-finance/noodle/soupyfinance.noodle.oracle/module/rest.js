...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryPrices = (assets, params = {}) => this.request(Object.assign({ path: `/soupy-finance/noodle/oracle/prices/${assets}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         * @request GET:/soupyfinance/noodle/oracle/params
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/soupyfinance/noodle/oracle/params`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
